...
def train(cfg, logger):
    ...
    if cfg.SOLVER.TRAIN_SODA and cfg.MODEL.PRETRAINED_CMIP != '':
        ...
        for k,v in model.named_parameters():
            if k.startswith('cnn.0.model.0') or k.startswith('cnn.0.model.1') or k.startswith('cnn.0.model.4') or \
                    k.startswith('cnn.1.model.0') or k.startswith('cnn.1.model.1') or k.startswith('cnn.1.model.4') or \
                    k.startswith('cnn.2.model.0') or k.startswith('cnn.2.model.1') or k.startswith('cnn.2.model.4') or \
                    k.startswith('cnn.3.model.0') or k.startswith('cnn.3.model.1') or k.startswith('cnn.3.model.4'):
